...
//   const getDataRowKeys = (row) => Object.keys(row).filter((c) => c !== headerMarker);
...
//             {headers.map((c) => {
//               return (
//                 <TableCell key={JSON.stringify(headersRow[c])} {...headerCellOptions(headersRow[c])}>
...
//                 return (
//                   <TableCell {...(i === 0 && { component: 'th', scope: 'row' })} key={cell} {...dataCellOptions(row[cell])}>
